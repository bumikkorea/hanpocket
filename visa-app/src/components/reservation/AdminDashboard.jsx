...
const T = {
  ...
  font: {
    family: "'Pretendard',-apple-system,BlinkMacSystemFont,'Apple SD Gothic Neo','Noto Sans KR',sans-serif",
  ...
  motion: {
    instant: "100ms", fast: "200ms", normal: "300ms", slow: "500ms", celebration: "700ms",
...
const f = (level) => ({ fontSize: T.font[level].size, fontWeight: T.font[level].weight, lineHeight: T.font[level].height, letterSpacing: T.font[level].spacing });
  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", background: T.color.bg, minHeight: "100vh", fontFamily: T.font.family, color: T.color.text1, WebkitFontSmoothing: "antialiased" }}>
      ...
      <div style={{ background: T.color.card, borderBottom: `1px solid ${T.color.border}`, padding: `${T.space[4]}px ${T.space[5]}px`, display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: T.space[2] }}>
        {loading ? [1,2,3,4].map(i => <div key={i} style={{ textAlign: "center" }}><Skel h={12} w="50%" style={{margin:"0 auto"}} /><Skel h={24} w="60%" style={{margin:"4px auto 0"}} /></div>) : [
