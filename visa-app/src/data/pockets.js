export const pocketCategories = [
  ...
  },
  {
    ...
    icon: 'Star',
    pockets: [
      { id: 'hallyu', name: { ko: '한류', zh: '韩流', en: 'Hallyu' }, icon: 'Star', description: { ko: 'K-POP, 드라마, 아이돌, 전통문화', zh: 'K-POP、韩剧、爱豆、传统文化', en: 'K-POP, drama, idols, culture' }, size: 'lg' },
  ...
  },
  {
    ...
    icon: 'Home',
    pockets: [
      { id: 'life', name: { ko: '생활', zh: '生活', en: 'Life' }, icon: 'Home', description: { ko: '한국 생활에 유용한 도구 모음', zh: '韩国生活实用工具集', en: 'Useful tools for life in Korea' }, size: 'lg' },
      { id: 'medical', name: { ko: '의료', zh: '医疗', en: 'Medical' }, icon: 'Heart', description: { ko: '병원 검색, 건강보험, 응급실', zh: '医院搜索、健康保险、急诊室', en: 'Hospital search, insurance, ER' }, size: 'lg' },
      { id: 'fitness', name: { ko: '운동', zh: '运动', en: 'Fitness' }, icon: 'TrendingUp', description: { ko: '공공 체육시설, 헬스장, 수영장', zh: '公共体育设施、健身房、游泳池', en: 'Public facilities, gym, pool' }, size: 'lg' },
      ...
      { id: 'realestate', name: { ko: '부동산 시세', zh: '房价行情', en: 'Real Estate' }, icon: 'Building2', description: { ko: '원룸/오피스텔', zh: '单间/officetel', en: 'Studios & officetels' }, size: 'sm' },
  ...
  },
  {
    ...
    icon: 'Wrench',
    pockets: [
      { id: 'translator', name: { ko: '통역', zh: '翻译', en: 'Translate' }, icon: 'ArrowLeftRight', description: { ko: '실시간 통역과 간판 사전', zh: '实时翻译和招牌词典', en: 'Real-time translation and sign dictionary' }, size: 'lg' },
      { id: 'artranslate', name: { ko: '간판 사전', zh: '招牌词典', en: 'Sign Dict' }, icon: 'FileText', description: { ko: '카메라로 간판을 보면서 아래 사전에서 검색하세요', zh: '对照相机中的招牌，在下方词典中搜索', en: 'View signs with camera and look up in the dictionary below' }, size: 'lg' },
      { id: 'sos', name: { ko: 'SOS', zh: 'SOS', en: 'SOS' }, icon: 'Siren', description: { ko: '위급할 때 도움을 요청하세요', zh: '紧急时刻寻求帮助', en: 'Request help in emergencies' }, size: 'lg' },
      { id: 'finance', name: { ko: '금융', zh: '金融', en: 'Finance' }, icon: 'DollarSign', description: { ko: '은행, 송금, 신용, 세금 완벽 가이드', zh: '银行、汇款、信用、税务完整指南', en: 'Complete guide to banking, remittance, credit, tax' }, size: 'lg' },
      { id: 'wallet', name: { ko: '월렛', zh: '钱包', en: 'Wallet' }, icon: 'Briefcase', description: { ko: '신분증, 서류, 이름을 한곳에서', zh: '证件、文件、姓名，一处管理', en: 'IDs, docs, and names in one place' }, size: 'lg' },
      { id: 'visaalert', name: { ko: '비자 알림', zh: '签证提醒', en: 'Visa Alert' }, icon: 'Clock', description: { ko: '비자 만료일 관리와 스마트 알림', zh: '签证到期日管理和智能提醒', en: 'Visa expiry management and smart alerts' }, size: 'lg' },
      { id: 'weatherCompare', name: { ko: '모국 날씨 비교', zh: '中韩天气对比', en: 'Weather Compare' }, icon: 'Cloud', description: { ko: '한국 vs 중국', zh: '韩国 vs 中国', en: 'Korea vs China' }, size: 'sm' },
      ...
      { id: 'trending', name: { ko: '실시간 인기', zh: '实时热门', en: 'Trending Now' }, icon: 'TrendingUp', description: { ko: '지금 많이 보는 정보', zh: '大家都在看', en: 'What everyone is viewing' }, size: 'sm' },
    ],
  },
]
