export const SCENE_PHRASE_DETAILS = {
  ...
  emergency: {
    ...
    phrases: [
      ...
      { ko: '응급실이 어디예요?', zh: '急诊室在哪里？', en: 'Where is the emergency room?', roman: 'eung-geup-sil-i eo-di-ye-yo' },
      { ko: '의사를 불러주세요', zh: '请叫医生', en: 'Please call a doctor', roman: 'ui-sa-reul bul-leo-ju-se-yo' },
      ...
      { ko: '배가 아파요', zh: '肚子疼', en: 'My stomach hurts', roman: 'bae-ga a-pa-yo' },
      { ko: '머리가 어지러워요', zh: '头晕', en: 'I feel dizzy', roman: 'meo-ri-ga eo-ji-reo-wo-yo' },
      { ko: '열이 나요', zh: '发烧了', en: 'I have a fever', roman: 'yeo-ri na-yo' },
      { ko: '숨쉬기 힘들어요', zh: '呼吸困难', en: 'Hard to breathe', roman: 'sum-swi-gi him-deu-reo-yo' },
      { ko: '다쳤어요', zh: '受伤了', en: 'I\'m injured', roman: 'da-chyeo-sseo-yo' },
      { ko: '보험이 되나요?', zh: '可以用保险吗？', en: 'Does insurance cover this?', roman: 'bo-heom-i doe-na-yo' },
      { ko: '처방전을 받으려면?', zh: '怎么拿处方？', en: 'How to get prescription?', roman: 'cheo-bang-jeon-eul bad-eu-ryeo-myeon' },
      { ko: '중국 대사관 번호', zh: '中国大使馆电话', en: 'Chinese embassy number', roman: 'jung-guk dae-sa-gwan beon-ho' },
