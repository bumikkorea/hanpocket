export const widgetCategories = [
  {
    ...
    widgets: [
      ...
      { id: 'restaurant', name: { ko: '맛집 추천', zh: '美食推荐', en: 'Restaurant Picks' }, icon: 'Utensils', description: { ko: '인기 맛집', zh: '人气餐厅', en: 'Popular restaurants' }, size: 'md' },
      ...
      { id: 'transport', name: { ko: '교통', zh: '交通', en: 'Transport' }, icon: 'Train', description: { ko: '지하철 노선도', zh: '地铁路线图', en: 'Subway map' }, size: 'sm' },
    ],
  },
  {
    id: 'essentials',
    name: { ko: '필수 도구', zh: '必备工具', en: 'Essential Tools' },
    icon: 'Wrench',
    widgets: [
      ...
      { id: 'emergency', name: { ko: '긴급 연락처', zh: '紧急联系方式', en: 'Emergency Contacts' }, icon: 'Siren', description: { ko: '경찰/소방/병원', zh: '警察/消防/医院', en: 'Police/Fire/Hospital' }, size: 'sm' },
  ...
  {
    id: 'community',
    name: { ko: '커뮤니티', zh: '社区', en: 'Community' },
    icon: 'Users',
    widgets: [
  ...
  {
    id: 'entertainment',
    name: { ko: '엔터테인먼트', zh: '娱乐', en: 'Entertainment' },
    icon: 'Clapperboard',
    widgets: [
  ...
  {
    id: 'fashion',
    name: { ko: '패션/뷰티', zh: '时尚美妆', en: 'Fashion & Beauty' },
    icon: 'Shirt',
    widgets: [
  ...
  {
    id: 'travel',
    name: { ko: '여행/문화', zh: '旅行文化', en: 'Travel & Culture' },
    icon: 'Plane',
    widgets: [
  ...
  {
    id: 'pet',
    name: { ko: '반려동물', zh: '宠物', en: 'Pets' },
    icon: 'PawPrint',
    widgets: [
      { id: 'pet', name: { ko: '반려동물 입국 가이드', zh: '宠物入境指南', en: 'Pet Entry Guide' }, icon: 'Dog', description: { ko: '반려동물 한국 입국 절차', zh: '宠物入境韩国流程', en: 'Pet import to Korea process' }, size: 'lg' },
    ],
  },
  {
    id: 'work',
    name: { ko: '취업/생활', zh: '就业/生活', en: 'Work & Living' },
    icon: 'Briefcase',
    widgets: [
...
// Mock data for widget content rendering
export const widgetMockData = {
  news: {
